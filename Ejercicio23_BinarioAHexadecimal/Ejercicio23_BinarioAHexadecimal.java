...
class Ejercicio23{
	...
	public static void main(String args[]){
		...
		//Utilizamos el metodo toHexString para para retornar a un valor hexadecimal el numero binario ingresado en la variable bin
		System.out.print("El numero "+bin+" a hexadecimal es: "+Integer.toHexString((Integer.parseInt(bin, 2))));

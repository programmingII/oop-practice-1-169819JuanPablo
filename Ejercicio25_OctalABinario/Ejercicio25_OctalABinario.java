...
class Ejercicio25{
	...
	public static void main(String args[]){
		...
		//Utilizamos la clase Integer para llamar el metodo parseInt para regresar la cadena que contiene en el numero octal a un valor en base 8 
		System.out.print("El numero "+bin+" a decimal es: "+(Integer.parseInt(bin, 8)));

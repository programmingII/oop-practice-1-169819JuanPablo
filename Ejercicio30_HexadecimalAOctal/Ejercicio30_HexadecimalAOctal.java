...
class Ejercicio30{
	...
	public static void main(String args[]){
		...
		//Usaremos la clase Integer y llamamos al metodo toOctalString para devolver el valor hexadecimal guardado en la variable hex a un valor de tipo octal
		System.out.print("El numero "+hex+" a binario es: "+Integer.toOctalString((Integer.parseInt(hex, 16))));

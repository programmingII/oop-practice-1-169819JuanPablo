...
class Ejercicio26{
	...
	public static void main(String args[]){
		...
		//Se utiliza el metodo toBinaryString de la clase Integer para convertir el valor de tipo octal en la variable oct a un valor de tipo binario 
		System.out.print("El numero "+oct+" a binario es: "+Integer.toBinaryString((Integer.parseInt(oct, 8))));

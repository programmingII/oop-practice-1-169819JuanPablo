...
class Ejercicio20{
	...
	public static void main(String args[]){
		...
		//Utilizamos la clase Integer para llamar el metodo toHexString para convertir el valor de num que es decimal a valor hexadecimal
		System.out.print("El numero "+num+" en hexadecimal es: "+Integer.toHexString(num));

...
class Ejercicio17{
	...
	public static void main(String args[]){
		//Declararemos la variable sum de tipo int en donde se guardara la suma de los numeros binarios
		int sum;
		...
		//Realizamos la suma de los binarios y la guardamos en la variable sum
		sum= num1+num2;
		//Utiliamos el metodo toBinaryString para convertir el valor dentro de suma en uno binario y lo imprimimos en pantalla
		System.out.println("La suma de los binarios "+b1+"+"+b2+" es: "+Integer.toBinaryString(sum));
